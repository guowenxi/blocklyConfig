...
PathObject.prototype.setClass_ = function(className, add) {
   ...
   */
  if (add) {
    className  === 'blocklySelected' && this.svgPath.setAttribute("filter","url(#selectBgColor)")
    dom.addClass(/** @type {!Element} */ (this.svgRoot), className);
  } else {
    className  === 'blocklySelected' && this.svgPath.removeAttribute("filter","url(#selectBgColor)")
