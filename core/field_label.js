 ...
 */
const FieldLabel = function(opt_value, opt_class, opt_config,state) {
  /**
  ...
  FieldLabel.superClass_.constructor.call(this, opt_value, null, opt_config,state);
 ...
 * @nocollapse
 */
FieldLabel.fromJson = function(options,state) {
  const text = parsing.replaceMessageReferences(options['text']);
  // `this` might be a subclass of FieldLabel if that class doesn't override
  // the static fromJson method.
  return new this(text, undefined, options,state);
};
